...
const InputField = ({ 
  ...
  return (
    <div className={`input-group ${className} `}>
      ...
      {IsOpcional && (<span className='text-gray-300 text-sm '> opcional</span>)}
      <br />
      <input
        id={id}
        className={`input-control ${error ? 'input-error' : ''}  bg-gray-100 p-2  text-gray-900 border-1 pl-3  border-gray-300 rounded-md w-full`}
